...
TemplateBase = ns.model(
    "PlatformOperationTemplateBase",
    {
        ...
        "variables": fields.Raw(required=False, description="Expected input variables schema (JSON)"),
        "outputs": fields.Raw(required=False, description="Typed output-field schema (JSON)"),
        "is_mutating": fields.Boolean(required=False, description="Flags change-type actions"),
        "is_active": fields.Boolean(required=False, description="Whether the action is enabled"),
